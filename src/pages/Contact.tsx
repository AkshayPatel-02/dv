        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl max-w-3xl mx-auto text-white/90">
              For collaborations, feedback, or event invites – drop us a message
            </p>
          </motion.div>
        </div>
      </section>
              ...
              <div className="card-academic">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button type="submit" className="btn-academic w-full">
            ...
            >
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-8">
                  ...
                  We look forward to hearing from you and building meaningful connections.
                </p>
              </div>
